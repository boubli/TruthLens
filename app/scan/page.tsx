...
return (
    <Box sx={{
        ...
        {/* Note: Html5QrcodeScanner handles its own UI, but we keep our HUD for style if possible,
               though Html5QrcodeScanner puts its own overlay. We will see if we need to remove our HUD or not.
               For now, keeping the minimalist HUD overlay on top for the "Pro" feel,
               hoping Html5QrcodeScanner video element sits behind it.
            */}
